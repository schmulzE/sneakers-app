 ...
 const colorVariants: Variants = {
  ...
  return (
    ...
    <div id="section-2" className='mt-10 relative px-14 py-64' ref={sectionTwo}>
      <div className="text-block hover:bg-black hover:text-white border-4 border-neutral-900 py-10 px-14 w-64 text-left absolute top-0 right-14 lg:right-[12%] lg:w-[350px] z-10 md:right-10">
      ...
      <div id="image-1" className="absolute top-0" >
        <img src="/Cromier-HP-Banner-Concept.jpg" className='max-w-[800px] lg:mt-20'/>
      </div>
    </div>
  
     <div className='px-4 grid md:grid-cols-2 mt-64 lg:mt-[500px] relative'>  
     <Swiper
        ...
        className=" w-52 lg:w-96 md:w-68 md:my-0 md:mt-28 my-8 lg:absolute lg:-top-28 lg:left-[5%]"
        >
        ...
        <div id="section-4" className='relative py-64 px-4'>
          ...
          <div id="image" className='absolute bottom-0 right-4 pt-4'>
            <img src={"/men.jpg"} className='max-w-[600px]'/>
          </div>
        </div>
      </div>


    <div className='px-2 grid md:grid-cols-2 mt-64 mb-[36px]'>
       <Swiper
        modules={[ Pagination, Autoplay ]}
        spaceBetween={50}
        slidesPerView={1}
      ...
      <div id="section-5" className='relative py-64 order-1'>
        ...
        <div id="image" className='absolute bottom-0 left-4 pt-4'>
          <img src='/women.jpg' className='max-w-[500px]'/>
        </div>
      </div>
    </div>
