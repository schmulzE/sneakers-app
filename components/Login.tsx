  ...
  return (
    <>
      <form onSubmit={formik.handleSubmit}>
        ...
        <input type='email' name='email' className='w-full rounded-md p-2 border border-slate-300  focus:border-neutral-900 focus:border-2' onChange={formik.handleChange} value={formik.values.email}/>
        ...
        <input type='password' name='password' className='relative w-full rounded-md p-2 border border-slate-300 focus:border-neutral-900  focus:border-2'  onChange={formik.handleChange} value={formik.values.password}/>
