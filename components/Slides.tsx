...
const nextSlide = () => {
  ...
  return (
    <div className='lg:max-w-[1050px] md:max-w-[1050px] md:h-[580px] max-w-[1400px] h-[780px] mb-24 md:mb-0 w-full lg:flex md:flex m-auto py-16 px-4 relative'>
      <div
        style={{ backgroundImage: `url(${slides[currentIndex].url})`}}
        className='lg:w-[50%] md:w-[50%] w-full md:h-[440px] lg:h-full h-full lg:absolute lg:top-0 lg:left-4 bg-center lg:mt-10 md:mt-0 bg-cover duration-500'
      ></div>
      <div
        style={{ backgroundImage: `url(${slide2[currentIndex].url})`}}
        className='w-[50%] md:h-[470px] absolute top-0 right-4 lg:h-full h-full bg-center bg-cover duration-500 hidden md:block lg:block'
      ></div>
